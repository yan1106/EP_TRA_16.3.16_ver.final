...
<body style="width: 100%; height:100%">
    <form id="form1" runat="server">
        <asp:Panel ID="POR_Panel" runat="server"> 
         <div class='container'>
        <div class='middle'>      
         <fieldset class="fieldset" style="width:70%;margin:auto;">
            <legend class="legend" style="font-weight: 700; font-size: large;  ">POR Golden</legend>   
            <table cellpadding="0" cellspacing="0" >
                ...
                <tr height="22">
                    ...
                    <th class="th_POR">Wafer Tech(nm)</th>
                    <td class="auto-style195">
            ...
            <br />
            <div class='left'>
             <fieldset class="fieldset" style="width:20%;margin:auto;">
            <legend class="legend" style="font-weight: 700; font-size: large;  ">New Device</legend>  
                ...
                <asp:Button ID="GAP_butt0" runat="server" class="blueButton button2" 
                Height="25px" OnClick="GAP_butt1" Text="GAP" Width="70px" />
                </div>   
                </div>        
